...
export default function Dashboard() {
  ...
  const fetchUserDetails = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://192.168.191.99:5000/api/users/getById/${userId}`, {
        method: "GET",
        headers: {
  ...
  const fetchRewards = async () => {
    try {
      ...
      const response = await fetch(`http://192.168.191.99:5000/api/rewards/${userId}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${accessToken}`,
  ...
  const logout = async () => {
    try {
      ...
      const response = await fetch("http://192.168.191.99:5000/api/users/logout", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${accessToken}`
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://192.168.191.99:5000/api/users/update-profile`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${accessToken}`
